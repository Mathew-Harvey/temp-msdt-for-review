 ...
 if (category === 'product') {
        ...
        content = `
            <div class="content-section">
                <h3>Advanced Marine Technology</h3>
                <p>Industry-leading ROVs, cleaning systems, and underwater equipment designed for professional maritime operations.</p>
                
                <button class="comparison-btn" onclick="showComparison()">
                    <i class="fas fa-chart-bar"></i> Compare ROV Models
                </button>
                ...
                <div class="media-gallery">
                    ...
                    <div class="gallery-thumbs">
                        ...
                        <div class="gallery-thumb" style="background: #FFE8E8;"></div>
                    </div>
                </div>
                
                <h3>Product Categories</h3>
                <ul>
                    <li><strong>ROV Systems:</strong> Revolution, Pivot, and Photon models for every application</li>
                    <li><strong>Crawler Systems:</strong> Magnetic and vacuum-based hull cleaning robots</li>
                    <li><strong>Filtration Units:</strong> 10μ capture systems for environmental compliance</li>
                    <li><strong>Software Platform:</strong> Digital biofouling management and compliance tracking</li>
                </ul>
            </div>
        `;
        ...
        content = `
            <div class="content-section">
                <h3>Equipment Maintenance & Servicing</h3>
                <p>Comprehensive maintenance programs to keep your marine equipment operating at peak performance and ensure regulatory compliance.</p>
                ...
                <div class="case-studies">
                    <div class="case-study-card">
                        ...
                        <div class="case-study-content">
                            <h4 class="case-study-title">Scheduled Maintenance Programs</h4>
                            <p class="case-study-description">Preventive maintenance schedules tailored to your equipment and operational requirements.</p>
                        </div>
                    </div>
                    <div class="case-study-card">
                        <div class="case-study-image">
                        ...
                        <div class="case-study-content">
                            <h4 class="case-study-title">Emergency Repairs</h4>
                            <p class="case-study-description">24/7 emergency repair services to minimize downtime and operational disruptions.</p>
                        </div>
                    </div>
                    <div class="case-study-card">
                        <div class="case-study-image">
                        ...
                        <div class="case-study-content">
                            <h4 class="case-study-title">Certification Renewals</h4>
                            <p class="case-study-description">Assistance with equipment certification and regulatory compliance renewals.</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        content = `
            <div class="content-section">
                <h3>Custom Solutions & Expert Consultation</h3>
                <p>Specialized maritime consultation and custom engineering solutions for unique operational challenges.</p>
                ...
                <h3>Our Consultation Services</h3>
                <div class="case-studies">
                    <div class="case-study-card">
                        <div class="case-study-image">
                        ...
                        <div class="case-study-content">
                            <h4 class="case-study-title">Regulatory Compliance Consulting</h4>
                            <p class="case-study-description">Expert guidance on maritime regulations, IMO guidelines, and biosecurity requirements.</p>
                        </div>
                    </div>
                    <div class="case-study-card">
                        <div class="case-study-image">
                        ...
                        <div class="case-study-content">
                            <h4 class="case-study-title">Custom Engineering Solutions</h4>
                            <p class="case-study-description">Bespoke engineering solutions for unique maritime challenges and requirements.</p>
                        </div>
                    </div>
                    <div class="case-study-card">
                        <div class="case-study-image">
                        ...
                        <div class="case-study-content">
                            <h4 class="case-study-title">Training Programs</h4>
                            <p class="case-study-description">Comprehensive training programs for crew and technical personnel.</p>
                        </div>
                    </div>
                </div>
            </div>
